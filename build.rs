...
const EJDICT_URL_DEFAULT: &'static str =
    "https://raw.githubusercontent.com/kujirahand/EJDict/master/release/ejdic-hand-utf8.txt";
...
fn main() -> io::Result<()> {
    ...
    let res = reqwest::get(&ejdict_url).unwrap().text().unwrap();
